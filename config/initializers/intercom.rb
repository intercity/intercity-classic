IntercomRails.config do |config|
  # == Intercom app_id
  #
  config.app_id = ENV["INTERCOM_APP_ID"] || "gvqp2yfr"

  # == Intercom secret key
  # This is required to enable secure mode, you can find it on your Intercom
  # "security" configuration page.
  #
  config.api_secret = ENV["INTERCOM_API_SECRET"] || "kQ7C16eUZoVcLs9HzC6ZUMK4cTVzXe82erQ5qvX"
  ...
  #
  config.api_key = ENV["INTERCOM_API_KEY"] || "8edb81e50640dc9b730478c009a6b3143be51417"
  ...
  config.user.custom_data = {
    :number_of_servers => Proc.new { |current_user| current_user.servers.not_archived.size },
    :number_of_applications => Proc.new { |current_user | current_user.applications.size }
  }
